 ...
 * @author Admin
 */
public class Node0 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Node0.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
