 ...
 * @author Admin
 */
public class Node6 extends javax.swing.JFrame {
    ...
    private void btnConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConnectActionPerformed
        if (this.tfPort.equals("")) {
            ...
            //#sua
            this.sv = new server(this, 3006, 6, this.tpLog, this.tpChatbox, this.tfAccountMoney, this.btnSendMoney);
            for (int i = 0; i < 5; i++) {
                if (i != this.sv.getId()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Node6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
